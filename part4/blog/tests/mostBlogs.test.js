...
describe("most blogs", () => {
  ...
  test('of a list with multiple top bloggers is first author in the list', () => {
    assert.deepStrictEqual(mostBlogs(listWithTwoTopBlogs), { author: 'Edsger W. Dijkstra', blogs: 2 })
  })
})