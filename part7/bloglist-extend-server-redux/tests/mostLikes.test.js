...
describe("most likes", () => {
  ...
  test('of a list with multiple top likes is first author in the list', () => {
    assert.deepStrictEqual(mostLikes(listWithTwoTopLikes), { author: 'Edsger W. Dijkstra', likes: 17 })
  })
})